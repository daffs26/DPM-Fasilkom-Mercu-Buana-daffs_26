...
export default function DetailProkerModal({ 
  ...
  const { ormawas, updateProkerDetails } = useStore();
              ...
              <div className="p-4 rounded-2xl border border-slate-200/80 bg-slate-50/50 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${
                    ...
                    {proker.proposal?.fileName ? 'Proposal Terlampir' : 'Belum Ada Berkas'}
                  </span>
                </div>
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-[10px] text-slate-400 block">
                        {proker.proposal?.uploadDate ? `Diunggah: ${proker.proposal.uploadDate}` : 'Menunggu pengunggahan berkas sah'}
                      </span>
                    </div>
                  </div>
